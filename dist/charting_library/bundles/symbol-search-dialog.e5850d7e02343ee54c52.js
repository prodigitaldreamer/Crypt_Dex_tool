"use strict";
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[1754], { 36383: (e, t, r) => {
            "use strict";
            r.d(t, { useOutsideEvent: () => s });
            var o = r(50959), i = r(27267);
            ...
            r.d(t, { Icon: () => i });
            var o = r(50959);
            const i = o.forwardRef(((e, t) => { const { icon: r = "", ...i } = e; return o.createElement("span", { ...i, ref: t, dangerouslySetInnerHTML: { __html: r } }); }));
        }, 99663: (e, t, r) => {
            "use strict";
            ...
            class s {
                ...
                setContainer(e) { const t = this._container, r = null === e ? this._document.createDocumentFragment() : e; !function (e, t) { Array.from(e.childNodes).forEach((e => { e.nodeType === Node.ELEMENT_NODE && t.appendChild(e); })); }(t, r), this._container = r; }
                registerWindow(e) { this._storage.has(e) || this._storage.add(e); }
                ensureWindow(e, t = { position: "fixed", direction: "normal" }) { const r = this._windows.get(e); if (void 0 !== r)
                    return r; this.registerWindow(e); const o = this._document.createElement("div"); if (o.style.position = t.position, o.style.zIndex = this._index.toString(), o.dataset.id = e, void 0 !== t.index) {
            ...
            function a(e = document) {
                ...
                if (null !== t)
                    return (0, o.ensureDefined)(n.get(t));
                {
                    const t = new s(e), r = function (e) {
            ...
            function i(e, t, r) { null !== e && e.style.setProperty(t, r); }
            function s(e, t) { return getComputedStyle(e, null).getPropertyValue(t); }
            function n(e, t) { return parseInt(s(e, t)); }
            let a = 0, c = !1;
            function l(e) { const { body: t } = document, r = t.querySelector(".widgetbar-wrap"); if (e && 1 == ++a) {
                const e = s(t, "overflow"), a = n(t, "padding-right");
                "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (i(r, "right", `${o()}px`), t.style.paddingRight = `${a + o()}px`, c = !0), t.classList.add("i-no-scroll");
            }
            ...
            function c(e) {
                ...
                function M() { i.unmountComponentAtNode(N), n.dialogsOpenerManager.setAsClosed("SymbolSearch"), g && g(); }
            ...
            var o = r(50959), i = r(962), s = r(25931), n = r(67961), a = r(99663);
            class c extends o.PureComponent {
                constructor() { super(...arguments), this._uuid = (0, s.nanoid)(); }
                ...
                _manager() { return null === this.context ? (0, n.getRootOverlapManager)() : this.context; }
            }
