...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[5057], { 45350: e => { e.exports = { "nav-button": "nav-button-znwuaSC1", link: "link-znwuaSC1", background: "background-znwuaSC1", icon: "icon-znwuaSC1", "flip-icon": "flip-icon-znwuaSC1", "size-large": "size-large-znwuaSC1", "preserve-paddings": "preserve-paddings-znwuaSC1", "size-medium": "size-medium-znwuaSC1", "size-small": "size-small-znwuaSC1", "size-xsmall": "size-xsmall-znwuaSC1", "size-xxsmall": "size-xxsmall-znwuaSC1", "visually-hidden": "visually-hidden-znwuaSC1" }; }, 55596: e => { e.exports = { dialog: "dialog-b8SxMnzX", wrapper: "wrapper-b8SxMnzX", separator: "separator-b8SxMnzX", bounded: "bounded-b8SxMnzX" }; }, 69827: e => { e.exports = { "small-height-breakpoint": "screen and (max-height: 360px)", container: "container-BZKENkhT", unsetAlign: "unsetAlign-BZKENkhT", title: "title-BZKENkhT", subtitle: "subtitle-BZKENkhT", textWrap: "textWrap-BZKENkhT", ellipsis: "ellipsis-BZKENkhT", close: "close-BZKENkhT", icon: "icon-BZKENkhT" }; }, 45719: e => { e.exports = { separator: "separator-Pf4rIzEt" }; }, 57340: (e, t, n) => {
            ...
            "use strict";
            n.d(t, { NavButton: () => c });
            var s = n(50959), r = n(97754), o = n(9745), i = n(45350);
            function a(e) { const { size: t = "large", preservePaddings: n, isLink: s, flipIconOnRtl: o, className: a } = e; return r(i["nav-button"], i[`size-${t}`], n && i["preserve-paddings"], o && i["flip-icon"], s && i.link, a); }
            function l(e) { const { children: t, icon: n } = e; return s.createElement(s.Fragment, null, s.createElement("span", { className: i.background }), s.createElement(o.Icon, { icon: n, className: i.icon, "aria-hidden": !0 }), t && s.createElement("span", { className: i["visually-hidden"] }, t)); }
            const c = (0, s.forwardRef)(((e, t) => { const { icon: n, type: r = "button", preservePaddings: o, flipIconOnRtl: i, size: c, "aria-label": d, ...u } = e; return s.createElement("button", { ...u, className: a({ ...e, children: d }), ref: t, type: r }, s.createElement(l, { icon: n }, d)); }));
            c.displayName = "NavButton";
            var d = n(21593), u = n(53017);
            (0, s.forwardRef)(((e, t) => { const { icon: n, renderComponent: r, "aria-label": o, ...i } = e, c = null != r ? r : d.CustomComponentDefaultLink; return s.createElement(c, { ...i, className: a({ ...e, children: o, isLink: !0 }), reference: (0, u.isomorphicRef)(t) }, s.createElement(l, { icon: n }, o)); })).displayName = "NavAnchorButton";
        }, 38952: (e, t, n) => {
            "use strict";
            function s(e) { const { reference: t, ...n } = e; return { ...n, ref: t }; }
            n.d(t, { renameRef: () => s });
        }, 21593: (e, t, n) => {
            "use strict";
            n.d(t, { CustomComponentDefaultLink: () => o });
            var s = n(50959), r = n(38952);
            function o(e) { return s.createElement("a", { ...(0, r.renameRef)(e) }); }
            s.PureComponent;
        }, 35057: (e, t, n) => {
            "use strict";
            n.d(t, { AdaptivePopupDialog: () => B });
            var s = n(50959), r = n(50151);
            var o = n(97754), i = n.n(o), a = n(68335), l = n(38223), c = n(35749), d = n(16181), u = n(1109), h = n(24437), p = n(90692), m = n(95711);
            var f = n(52092), g = n(76422), v = n(11542), w = n(57340);
            const C = s.createContext({ setHideClose: () => { } });
            var b = n(69827);
            function _(e) { const { title: t, titleTextWrap: r = !1, subtitle: o, showCloseIcon: a = !0, onClose: l, onCloseButtonKeyDown: c, renderBefore: d, renderAfter: u, draggable: h, className: p, unsetAlign: m, closeAriaLabel: f = v.t(null, void 0, n(80395)), closeButtonReference: g } = e, [_, E] = (0, s.useState)(!1); return s.createElement(C.Provider, { value: { setHideClose: E } }, s.createElement("div", { className: i()(b.container, p, (o || m) && b.unsetAlign) }, d, s.createElement("div", { "data-dragg-area": h, className: b.title }, s.createElement("div", { className: i()(r ? b.textWrap : b.ellipsis) }, t), o && s.createElement("div", { className: i()(b.ellipsis, b.subtitle) }, o)), u, a && !_ && s.createElement(w.CloseButton, { className: b.close, "data-name": "close", "aria-label": f, onClick: l, onKeyDown: c, ref: g, size: "medium", preservePaddings: !0 }))); }
            var E = n(53017), x = n(90186), N = n(55596);
            const k = { vertical: 20 }, S = { vertical: 0 };
            class B extends s.PureComponent {
                constructor() { super(...arguments), this._controller = null, this._reference = null, this._orientationMediaQuery = null, this._renderChildren = (e, t) => (this._controller = e, this.props.render({ requestResize: this._requestResize, centerAndFit: this._centerAndFit, isSmallWidth: t })), this._handleReference = e => this._reference = e, this._handleCloseBtnClick = () => { this.props.onKeyboardClose && this.props.onKeyboardClose(), this._handleClose(); }, this._handleClose = () => { this.props.onClose(); }, this._handleOpen = () => { void 0 !== this.props.onOpen && this.props.isOpened && this.props.onOpen(this.props.fullScreen || window.matchMedia(h.DialogBreakpoints.TabletSmall).matches); }, this._handleKeyDown = e => { if (!e.defaultPrevented) {
                    if (this.props.onKeyDown && this.props.onKeyDown(e), 27 === (0, a.hashFromEvent)(e)) {
                        ...
                        const { activeElement: n } = document, s = (0, r.ensureNotNull)(this._reference);
                        if (null !== n) {
                ...
                componentDidMount() {
                    var e, t;
                    this.props.ignoreClosePopupsAndDialog || g.subscribe(f.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this._handleClose, null), this._handleOpen(),
                ...
                focus() { (0, r.ensureNotNull)(this._reference).focus(); }
