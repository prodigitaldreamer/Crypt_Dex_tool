"use strict";
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[731], { 59142: function (e, t) { var o, r, a; r = [t], o = function (e) {
            "use strict";
            ...
            e.disableBodyScroll = function (e, r) { if (a) {
                ...
                if (e && !n.some((function (t) { return t.targetElement === e; }))) {
                    ...
                    n = [].concat(t(n), [m]), e.ontouchstart = function (e) { 1 === e.targetTouches.length && (i = e.targetTouches[0].clientY); }, e.ontouchmove = function (t) { var o, r, a, n; 1 === t.targetTouches.length && (r = e, n = (o = t).targetTouches[0].clientY - i, !d(o.target) && (r && 0 === r.scrollTop && 0 < n || (a = r) && a.scrollHeight - a.scrollTop <= a.clientHeight && n < 0 ? u(o) : o.stopPropagation())); }, s || (document.addEventListener("touchmove", u, o ? { passive: !1 } : void 0), s = !0);
                }
            }
            else {
                ...
                n = [].concat(t(n), [h]);
            } var p; }, e.clearAllBodyScrollLocks = function () { a ? (n.forEach((function (e) { e.targetElement.ontouchstart = null, e.targetElement.ontouchmove = null; })), s && (document.removeEventListener("touchmove", u, o ? { passive: !1 } : void 0), s = !1), n = [], i = -1) : (m(), n = []); }, e.enableBodyScroll = function (e) { if (a) {
                if (!e)
                ...
                e.ontouchstart = null, e.ontouchmove = null, n = n.filter((function (t) { return t.targetElement !== e; })), s && 0 === n.length && (document.removeEventListener("touchmove", u, o ? { passive: !1 } : void 0), s = !1);
            }
            else
                1 === n.length && n[0].targetElement === e ? (m(), n = []) : n = n.filter((function (t) { return t.targetElement !== e; })); };
        }, void 0 === (a = "function" == typeof o ? o.apply(t, r) : o) || (e.exports = a); }, 70048: e => {
            e.exports = { wrapper: "wrapper-GZajBGIm", input: "input-GZajBGIm", box: "box-GZajBGIm", icon: "icon-GZajBGIm", noOutline: "noOutline-GZajBGIm", "intent-danger": "intent-danger-GZajBGIm", check: "check-GZajBGIm",
                dot: "dot-GZajBGIm" };
        }, 57222: e => { e.exports = { button: "button-Rc93kXa8", bordersVisible: "bordersVisible-Rc93kXa8", selected: "selected-Rc93kXa8" }; }, 17723: e => { e.exports = { footer: "footer-dwINHZFL" }; }, 85286: e => { e.exports = { wrap: "wrap-oc7l8ZQg", header: "header-oc7l8ZQg", item: "item-oc7l8ZQg" }; }, 44467: e => { e.exports = { label: "label-lVJKBKVk" }; }, 78724: e => { e.exports = { scrollable: "scrollable-sXALjK1u", spinnerWrap: "spinnerWrap-sXALjK1u", item: "item-sXALjK1u", heading: "heading-sXALjK1u", checkboxWrap: "checkboxWrap-sXALjK1u", checkbox: "checkbox-sXALjK1u", emptyState: "emptyState-sXALjK1u", image: "image-sXALjK1u", text: "text-sXALjK1u" }; }, 10341: e => { e.exports = { dialog: "dialog-IKuIIugL", tabletDialog: "tabletDialog-IKuIIugL", desktopDialog: "desktopDialog-IKuIIugL" }; }, 66076: e => { e.exports = { "default-drawer-min-top-distance": "100px", wrap: "wrap-_HnK0UIN", positionBottom: "positionBottom-_HnK0UIN", backdrop: "backdrop-_HnK0UIN", drawer: "drawer-_HnK0UIN", positionLeft: "positionLeft-_HnK0UIN" }; }, 71986: e => { e.exports = { "tablet-small-breakpoint": "screen and (max-width: 430px)", item: "item-jFqVJoPk", hovered: "hovered-jFqVJoPk", isDisabled: "isDisabled-jFqVJoPk", isActive: "isActive-jFqVJoPk", shortcut: "shortcut-jFqVJoPk", toolbox: "toolbox-jFqVJoPk", withIcon: "withIcon-jFqVJoPk", "round-icon": "round-icon-jFqVJoPk", icon: "icon-jFqVJoPk", labelRow: "labelRow-jFqVJoPk", label: "label-jFqVJoPk", showOnHover: "showOnHover-jFqVJoPk", "disclosure-item-circle-logo": "disclosure-item-circle-logo-jFqVJoPk", showOnFocus: "showOnFocus-jFqVJoPk" }; }, 70673: (e, t, o) => {
            "use strict";
            o.d(t, { CheckboxInput: () => d });
            var r = o(50959), a = o(97754), n = o(90186), s = o(9745), i = o(65890), l = o(70048), c = o.n(l);
            function d(e) { const t = a(c().box, c()[`intent-${e.intent}`], { [c().check]: !Boolean(e.indeterminate), [c().dot]: Boolean(e.indeterminate), [c().noOutline]: -1 === e.tabIndex }), o = a(c().wrapper, e.className); return r.createElement("span", { className: o, title: e.title, style: e.style }, r.createElement("input", { id: e.id, tabIndex: e.tabIndex, className: c().input, type: "checkbox", name: e.name, checked: e.checked, disabled: e.disabled, value: e.value, autoFocus: e.autoFocus, role: e.role, onChange: function () { e.onChange && e.onChange(e.value); }, ref: e.reference, "aria-required": e["aria-required"], "aria-describedby": e["aria-describedby"], "aria-invalid": e["aria-invalid"], ...(0, n.filterDataProps)(e) }), r.createElement("span", { className: t }, r.createElement(s.Icon, { icon: i, className: c().icon }))); }
        }, 36383: (e, t, o) => {
            "use strict";
            o.d(t, { useOutsideEvent: () => n });
            var r = o(50959), a = o(27267);
            function n(e) { const { click: t, mouseDown: o, touchEnd: n, touchStart: s, handler: i, reference: l, ownerDocument: c = document } = e, d = (0, r.useRef)(null), u = (0, r.useRef)(new CustomEvent("timestamp").timeStamp); return (0, r.useLayoutEffect)((() => { const e = { click: t, mouseDown: o, touchEnd: n, touchStart: s }, r = l ? l.current : d.current; return (0, a.addOutsideEventListener)(u.current, r, i, c, e); }), [t, o, n, s, i]), l || d; }
        }, 9745: (e, t, o) => {
            "use strict";
            o.d(t, { Icon: () => a });
            var r = o(50959);
            const a = r.forwardRef(((e, t) => { const { icon: o = "", ...a } = e; return r.createElement("span", { ...a, ref: t, dangerouslySetInnerHTML: { __html: o } }); }));
        }, 99663: (e, t, o) => {
            "use strict";
            o.d(t, {
                Slot: () => a, SlotContext: () => n
            });
            var r = o(50959);
            class a extends r.Component {
                shouldComponentUpdate() { return !1; }
                render() { return r.createElement("div", { style: { position: "fixed", zIndex: 150, left: 0, top: 0 }, ref: this.props.reference }); }
            }
            ...
            class n {
                constructor(e = document) { this._storage = new a, this._windows = new Map, this._index = 0, this._document = e, this._container = e.createDocumentFragment(); }
                setContainer(e) { const t = this._container, o = null === e ? this._document.createDocumentFragment() : e; !function (e, t) { Array.from(e.childNodes).forEach((e => { e.nodeType === Node.ELEMENT_NODE && t.appendChild(e); })); }(t, o), this._container = o; }
                registerWindow(e) { this._storage.has(e) || this._storage.add(e); }
                ensureWindow(e, t = { position: "fixed", direction: "normal" }) { const o = this._windows.get(e); if (void 0 !== o)
                    return o; this.registerWindow(e); const r = this._document.createElement("div"); if (r.style.position = t.position, r.style.zIndex = this._index.toString(), r.dataset.id = e, void 0 !== t.index) {
                    ...
                    "reverse" === t.direction ? this._container.insertBefore(r, this._container.firstChild) : this._container.appendChild(r); return this._windows.set(e, r), ++this._index, r; }
            ...
            const s = new WeakMap;
            function i(e = document) { const t = e.getElementById("overlap-manager-root"); if (null !== t)
                return (0, r.ensureDefined)(s.get(t)); {
                const t = new n(e), o = function (e) { const t = e.createElement("div"); return t.style.position = "absolute", t.style.zIndex = 150..toString(), t.style.top = "0px", t.style.left = "0px", t.id = "overlap-manager-root", t; }(e);
                return s.set(o, t), t.setContainer(o), e.body.appendChild(o), t;
            } }
        }, 99054: (e, t, o) => {
            "use strict";
            o.d(t, { setFixedBodyState: () => c });
            const r = (() => { let e; return () => { var t; if (void 0 === e) {
            ...
            function a(e, t, o) { null !== e && e.style.setProperty(t, o); }
            function n(e, t) {
                return getComputedStyle(e, null).getPropertyValue(t);
            }
            function s(e, t) { return parseInt(n(e, t)); }
            let i = 0, l = !1;
            function c(e) { const { body: t } = document, o = t.querySelector(".widgetbar-wrap"); if (e && 1 == ++i) {
                const e = n(t, "overflow"), i = s(t, "padding-right");
                "hidden" !== e.toLowerCase() && t.scrollHeight > t.offsetHeight && (a(o, "right", `${r()}px`), t.style.paddingRight = `${i + r()}px`, l = !0), t.classList.add("i-no-scroll");
            }
            ...
            o.d(t, { Measure: () => a });
            var r = o(67842);
            function a(e) { const { children: t, onResize: o } = e; return t((0, r.useResizeObserver)(o || (() => { }), [null === o])); }
        }, 39362: (e, t, o) => {
            "use strict";
            o.d(t, { SymbolSearchDialogFooter: () => i });
            var r = o(50959), a = o(97754), n = o.n(a), s = o(17723);
            function i(e) { const { className: t, children: o } = e; return r.createElement("div", { className: n()(s.footer, t) }, o); }
        }, 14283: (e, t, o) => {
            "use strict";
            o.r(t), o.d(t, { getCompareDialogRenderer: () => se });
            var r = o(50959), a = o(11542), n = o(32563), s = o(14483), i = o(65106), l = o(97754), c = o.n(l), d = o(50151), u = o(9745), m = o(86656), h = o(77975), p = o(63932), v = o(26843), f = o(45345), b = o(45601), g = o(84524), y = o(17531);
            const _ = r.createContext(null);
            var S = o(70412), k = o(77762);
            const x = r.createContext(null);
            var w = o(16396), I = o(41590), C = o(37558), N = o(57222);
            function E(e) { const { theme: t = N, children: o, onClick: a, isSelected: n, areBordersVisible: s, isItemSelected: i, className: l, value: d, name: u } = e; return r.createElement("button", { type: "button", className: c()(l, t.button, n && t.selected, s && !n && !i && t.bordersVisible), name: u, value: d, onClick: a }, o); }
            function M(e) { const { value: t, onClick: o, ...a } = e, n = (0, r.useCallback)((e => o(t, e)), [t, o]); return r.createElement(E, { ...a, value: String(t), onClick: n }); }
            var D = o(46148);
            function z(e) { const { compareModel: t, selectedCompareOptionIndex: n } = (0, k.useEnsuredContext)(_), s = t.comparableOnSameScale({ isYield: e }), i = (0, r.useMemo)((() => function (e) { return [{ label: e ? a.t(null, void 0, o(17547)) : a.t(null, void 0, o(82642)), compareOption: e ? D.CompareOption.SameScale : D.CompareOption.SamePctScale }, { label: a.t(null, void 0, o(34420)), compareOption: D.CompareOption.NewPriceScale }, { label: a.t(null, void 0, o(67242)), compareOption: D.CompareOption.NewPane }]; }(s)), [s]); return [(0, r.useMemo)((() => { var e, t; return null !== (t = null === (e = i[n]) || void 0 === e ? void 0 : e.compareOption) && void 0 !== t ? t : i[0].compareOption; }), [i, n]), i]; }
            var L = o(85286);
            function T(e) {
                const { fullSymbolName: t, isSelected: n, className: s, isYield: l } = e, { isMobile: d, searchRef: u, setMode: m } = (0, k.useEnsuredContext)(g.SymbolSearchItemsDialogContext), { compareModel: h, setHoveredItemId: p, clearInput: v, allowExtendTimeScale: f } = (0, k.useEnsuredContext)(_), { callback: b } = (0, k.useEnsuredContext)(x), [y, S] = z(l);
                return d ? r.createElement(C.DrawerManager, null, r.createElement(I.Drawer, { position: "Bottom", onClose: N.bind(null, !1) }, r.createElement("div", { className: L.header }, a.t(null, void 0, o(79589))), S.map((({ label: e, compareOption: t }) => r.createElement(w.PopupMenuItem, { key: t, className: L.item, onClick: E, onClickArg: t, label: e
                }))))) : r.createElement("div", { className: c()(L.wrap, s), "data-name": "compare-buttons-group" }, S.map((({ label: e, compareOption: t }) => r.createElement(M, { key: t, onClick: E, value: t, isItemSelected: Boolean(n), isSelected: n && y === t }, e))));
                function N(e) { d && b && b(), v && e && v(u, m); }
                function E(e, o) { if (o.preventDefault(), h && t && void 0 !== e) {
                    (0, i.getSymbolSearchCompleteOverrideFunction)()(t).then((t => { h.applyStudy(t.symbol, e, f), p(""), N(!0); }));
                } }
            }
            function A(e) { const { isSelected: t, fullSymbolName: o, onExpandClick: a, actions: s, id: l, isOffset: c, isYield: d } = e, { isMobile: u, toggleExpand: m, searchSpreads: h, searchRef: p, setMode: v, mode: f } = (0, k.useEnsuredContext)(g.SymbolSearchItemsDialogContext), { compareModel: b, hoveredItemId: w, setHoveredItemId: I, clearInput: C, allowExtendTimeScale: N } = (0, k.useEnsuredContext)(_), [E, M] = (0, r.useState)(!1), z = (0, r.useRef)(null), L = (0, S.useAccurateHover)(z), A = (0, r.useMemo)((() => ({ callback: P })), [P]), B = !Boolean(a) && !Boolean(s), j = l === w; return r.createElement(x.Provider, { value: A }, r.createElement(y.SymbolSearchDialogContentItem, { hideMarkedListFlag: "compare" === f, ...e, reference: z, onClick: function (t) { if (Boolean(a) && l && !c)
                    return null == t || t.preventDefault(), void m(l); if (!E && u)
                    return void M(!0); if (h && e.onClick)
                    return void e.onClick(t); if ((n.mobiletouch ? j : !E) && o) {
                    (0, i.getSymbolSearchCompleteOverrideFunction)()(o).then((e => { const t = b.comparableOnSameScale({ isYield: d }) ? D.CompareOption.SameScale : D.CompareOption.SamePctScale; b.applyStudy(e.symbol, t, N); })), I(""), C && C(p, v);
                } n.mobiletouch && !u && !j && l && I(l); }, hoverComponent: function () { if (!B)
                    return !1; if (u)
                    return E; if (n.mobiletouch)
                    return j; return Boolean(L || t); }() ? T : void 0 })); function P() { M(!1); } }
            var B = o(15550), j = o(93986), P = o(39750), H = o(78724);
            function R(e) {
                const { handleListWidth: t } = (0, d.ensureNotNull)((0, r.useContext)(g.SymbolSearchItemsDialogContext)), { compareModel: n, selectedCompareIndex: s, selectedItemRef: i } = (0, d.ensureNotNull)((0, r.useContext)(_)), l = (0, h.useWatchedValueReadonly)({ watchedValue: n.isDataReady() }), S = (0, h.useWatchedValueReadonly)({ watchedValue: n.studies() }), k = (0, h.useWatchedValueReadonly)({ watchedValue: n.highlightedSymbol() }), x = (0, r.useMemo)((() => S.filter((e => e.checked))), [S]), w = (0, r.useMemo)((() => S.filter((e => !e.checked))), [S]);
                return (0, r.useEffect)((() => (n.chartModel().dataSourceCollectionChanged().subscribe(n, n.handleSourcesChange), () => n.chartModel().dataSourceCollectionChanged().unsubscribe(n, n.handleSourcesChange))), [n]), r.createElement(b.Measure, { onResize: function ([e]) { t(e.contentRect.width); } }, (e => r.createElement(m.TouchScrollContainer, { className: H.scrollable, ref: e }, function () {
                    if (!l)
                        return r.createElement("div", { className: H.spinnerWrap }, r.createElement(p.Spinner, null));
                    if (!Boolean(x.length) && !Boolean(w.length)) {
                        const e = f.watchedTheme.value() === v.StdTheme.Dark ? j : B;
                        return r.createElement("div", { className: H.emptyState }, r.createElement(u.Icon, { className: H.image, icon: e }), r.createElement("div", { className: H.text }, a.t(null, void 0, o(42078))));
                    }
                    return r.createElement(r.Fragment, null, Boolean(x.length) && r.createElement(r.Fragment, null, r.createElement("div", { className: H.heading
                    }, a.t(null, void 0, o(46580))), x.map(((e, t) => r.createElement(y.SymbolSearchDialogContentItem, { "data-role": "added-symbol-item", className: H.item, key: e.id, id: e.id, shortName: e.title, title: e.title, logoId: e.logoId, currencyLogoId: e.currencyLogoId, baseCurrencyLogoId: e.baseCurrencyLogoId, dangerousDescriptionHTML: e.description, exchangeName: e.exchangeName, marketType: e.marketType, country: e.country, providerId: e.providerId, onClick: I.bind(null, e), isHighlighted: e.id === k, isSelected: C(e), itemRef: C(e) ? i : void 0, isYield: e.isYield, actions: r.createElement("div", { className: H.checkboxWrap }, r.createElement(E, { className: H.checkbox, onClick: I.bind(null, e), isSelected: C(e) }, r.createElement(u.Icon, { icon: P }))) })))), Boolean(w.length) && r.createElement(r.Fragment, null, r.createElement("div", { className: H.heading }, a.t(null, void 0, o(57570))), w.map((e => r.createElement(A, { "data-role": "recent-symbol-item", className: c()(H.item, e.id === k && H.highlighted), key: e.id, id: e.id, shortName: e.title, logoId: e.logoId, currencyLogoId: e.currencyLogoId, baseCurrencyLogoId: e.baseCurrencyLogoId, title: e.title, dangerousDescriptionHTML: e.description, exchangeName: e.exchangeName, marketType: e.marketType, country: e.country, providerId: e.providerId, fullSymbolName: e.symbol, isSelected: C(e), itemRef: C(e) ? i : void 0, isYield: e.isYield })))));
                }())));
                function I(e, t) { null == t || t.preventDefault(), n.removeStudy(e); }
                function C(e) { return S.indexOf(e) === s; }
            }
            var O = o(56840);
            class W extends r.PureComponent {
                constructor(e) { super(e), this._selectedItemRef = r.createRef(), this._getContextValue = () => { const { compareModel: e } = this.props, { selectedCompareOptionIndex: t, selectedCompareIndex: o, hoveredItemId: r, allowExtendTimeScale: a } = this.state; return { compareModel: e, selectedCompareOptionIndex: t, setSelectedCompareOptionIndex: this._setSelectedCompareOptionIndex, hoveredItemId: r, setHoveredItemId: this._setHoveredItemId, selectedCompareIndex: o, setSelectedCompareIndex: this._setSelectedCompareIndex, selectedItemRef: this._selectedItemRef, clearInput: this._clearInput, allowExtendTimeScale: a, toggleAllowExtendTimeScale: this._toggleAllowExtendTimeScale }; }, this._clearInput = (e, t) => { e && e.current && (e.current.value = "", t("compare")); }, this._setSelectedCompareOptionIndex = e => { this.setState({ selectedCompareOptionIndex: e }); }, this._setHoveredItemId = e => { this.setState({ hoveredItemId: e }); }, this._setSelectedCompareIndex = (e, t) => { this.setState({ selectedCompareIndex: e }, t); }, this._toggleAllowExtendTimeScale = () => { const e = !this.state.allowExtendTimeScale; O.setValue("showAddSymbolDialog.extendCheckboxState", e), this.setState({ allowExtendTimeScale: e }); }, this.state = { selectedCompareOptionIndex: 0, selectedCompareIndex: -1, hoveredItemId: void 0, allowExtendTimeScale: Boolean(O.getBool("showAddSymbolDialog.extendCheckboxState")) }; }
                render() { const { children: e } = this.props; return r.createElement(_.Provider, { value: this._getContextValue() }, e); }
            }
            var F = o(68335), U = o(35057), Y = o(16838), q = o(10341);
            function K(e) {
                const { openedItems: t, searchRef: o, feedItems: a, selectedIndex: n, toggleExpand: s, onSearchComplete: i, mode: c, setMode: d, setSelectedIndex: u, isMobile: m, isTablet: p, onClose: v, upperCaseEnabled: f, symbolSearchState: b } = (0, k.useEnsuredContext)(g.SymbolSearchItemsDialogContext), { compareModel: y, hoveredItemId: S, setHoveredItemId: x, selectedCompareOptionIndex: w, setSelectedCompareOptionIndex: I, selectedCompareIndex: C, setSelectedCompareIndex: N, selectedItemRef: E, clearInput: M, allowExtendTimeScale: D } = (0, k.useEnsuredContext)(_), L = (0, h.useWatchedValueReadonly)({ watchedValue: y.studies() }), T = a[n], A = "compare" === c, B = "exchange" === c, j = A ? C : n, P = A ? L : a, H = P[j], [R, O] = z(null == H ? void 0 : H.isYield);
                return (0, r.useEffect)((() => { S && x(""), C && N(-1); }), [c]), r.createElement(U.AdaptivePopupDialog, { ...e, className: l(q.dialog, !m && (p ? q.tabletDialog : q.desktopDialog)), onKeyDown: function (e) { var r; const a = (0, F.hashFromEvent)(e); switch (a) {
                        case 13: {
                            if (A)
                                return void function () { if (-1 === C)
                                    return; const e = L[C]; e.checked ? y.removeStudy(e) : y.applyStudy(e.symbol, R, D); N(-1); }();
                            const t = V();
                            if (t)
                        ...
                        case 27: return e.preventDefault(), B ? void d("symbolSearch") : void v();
                    } if (!A && "good" !== b)
                        return; switch ((0, Y.mapKeyCodeToDirection)(a)) {
                        case "blockPrev":
                            if (e.preventDefault(), 0 === j)
                                return;
                            if (-1 === j)
                                return void W(0);
                            W(j - 1);
                            break;
                        case "blockNext":
                            if (e.preventDefault(), j === P.length - 1)
                                return;
                            W(j + 1);
                            break;
                        case "inlinePrev": {
                            const o = V();
                            if (o && t.has(o))
                                return e.preventDefault(), void s(o);
                            if (!w || o)
                                return;
                    ...
                    } }, dataName: "compare-dialog", draggable: !0 });
                function W(e) { A ? N(e, K) : u(e); }
                function K() { var e; null === (e = E.current) || void 0 === e || e.scrollIntoView({ block: "nearest" }); }
                function V() { if (!T)
                    return; const { id: e, isOffset: t, onExpandClick: o } = T; return !t && Boolean(o) && e ? e : void 0; }
            }
            var V = o(962), Z = o(22350), G = o(85067);
            class J extends G.DialogRenderer {
                constructor(e) { super(), this._props = e; }
                show(e) { if (this.visible().value())
                    return; const t = r.createElement(Z.SymbolSearchItemsDialog, { ...this._props, shouldReturnFocus: null == e ? void 0 : e.shouldReturnFocus, initialMode: this._props.initialMode || "symbolSearch", onClose: () => this.hide() }); V.render(t, this._container), this._setVisibility(!0); }
                hide() { var e, t; V.unmountComponentAtNode(this._container), this._visibility.setValue(!1), null === (t = (e = this._props).onClose) || void 0 === t || t.call(e); }
            }
            var X = o(81319), Q = o(69654), $ = o(70613);
            function ee(e) {
                const { searchRef: t, setMode: o } = (0, k.useEnsuredContext)(g.SymbolSearchItemsDialogContext), { currentMode: a } = (0, k.useEnsuredContext)($.SymbolSearchDialogBodyContext);
                return (0, r.useEffect)((() => { const e = t.current; if (e)
                    return e.addEventListener("input", n), () => { e && e.removeEventListener("input", n); }; }), []), r.createElement(Q.DialogSearch, { ...e });
                function n() {
                    var e, r, n, s;
            ...
            var te = o(70673), oe = o(39362), re = o(44467);
            function ae(e) { const { allowExtendTimeScale: t, toggleAllowExtendTimeScale: n } = (0, d.ensureNotNull)((0, r.useContext)(_)); return r.createElement(oe.SymbolSearchDialogFooter, null, r.createElement("label", { "data-name": "allow-extend-time-scale-checkbox" }, r.createElement(te.CheckboxInput, { checked: t, value: t ? "on" : "off", onChange: n }), r.createElement("span", { className: re.label }, a.t(null, void 0, o(71046))))); }
            const ne = s.enabled("secondary_series_extend_time_scale");
            function se(e) { return new J({ wrapper: (t = e, e => r.createElement(W, { ...e, compareModel: t })), dialog: K, contentItem: A, initialScreen: R, searchInput: ee, footer: ne ? r.createElement(ae) : void 0, initialMode: "compare", dialogTitle: a.t(null, void 0, o(22320)), autofocus: !n.mobiletouch, dialogWidth: "fixed", onSearchComplete: t => { const { compareOption: o, allowExtendTimeScale: r } = t[0]; if (void 0 !== o) {
                    (0, i.getSymbolSearchCompleteOverrideFunction)()(t[0].symbol, t[0].result).then((t => { e.applyStudy(t.symbol, o, r); }));
                } }, symbolTypes: (0, X.getAvailableSymbolTypes)(), showSpreadActions: s.enabled("show_spread_operators") && s.enabled("compare_symbol_search_spread_operators") }); var t; }
        }, 46148: (e, t, o) => {
            "use strict";
            var r;
            o.d(t, { CompareOption: () => r }), function (e) { e[e.SamePctScale = 0] = "SamePctScale", e[e.NewPriceScale = 1] = "NewPriceScale", e[e.NewPane = 2] = "NewPane", e[e.SameScale = 3] = "SameScale"; }(r || (r = {}));
        }, 37558: (e, t, o) => {
            "use strict";
            o.d(t, { DrawerContext: () => s, DrawerManager: () => n });
            var r = o(50959), a = o(99054);
            class n extends r.PureComponent {
                ...
                componentDidUpdate(e, t) { !t.stack.length && this.state.stack.length && ((0, a.setFixedBodyState)(!0), this._isBodyFixed = !0), t.stack.length && !this.state.stack.length && this._isBodyFixed && ((0, a.setFixedBodyState)(!1), this._isBodyFixed = !1); }
                componentWillUnmount() { this.state.stack.length && this._isBodyFixed && (0, a.setFixedBodyState)(!1); }
                render() { return r.createElement(s.Provider, { value: { addDrawer: this._addDrawer, removeDrawer: this._removeDrawer, currentDrawer: this.state.stack.length ? this.state.stack[this.state.stack.length - 1] : null } }, this.props.children); }
            }
            const s = r.createContext(null);
        }, 41590: (e, t, o) => {
            "use strict";
            o.d(t, { Drawer: () => m });
            var r = o(50959), a = o(50151), n = o(97754), s = o(36174), i = o(42842), l = o(37558), c = o(29197), d = o(86656), u = o(66076);
            function m(e) {
                const { position: t = "Bottom", onClose: o, children: d, className: m, theme: p = u } = e, v = (0, a.ensureNotNull)((0, r.useContext)(l.DrawerContext)), [f] = (0, r.useState)((() => (0, s.randomHash)())), b = (0, r.useRef)(null), g = (0, r.useContext)(c.CloseDelegateContext);
                return (0, r.useLayoutEffect)((() => ((0, a.ensureNotNull)(b.current).focus({
                    preventScroll: !0
                }), g.subscribe(v, o), v.addDrawer(f), () => { v.removeDrawer(f), g.unsubscribe(v, o); })), []), r.createElement(i.Portal, null, r.createElement("div", { className: n(u.wrap, u[`position${t}`]) }, f === v.currentDrawer && r.createElement("div", { className: u.backdrop, onClick: o }), r.createElement(h, { className: n(p.drawer, u[`position${t}`], m), ref: b, "data-name": e["data-name"] }, d)));
            }
            const h = (0, r.forwardRef)(((e, t) => { const { className: o, ...a } = e; return r.createElement(d.TouchScrollContainer, { className: n(u.drawer, o), tabIndex: -1, ref: t, ...a }); }));
        }, 70412: (e, t, o) => {
            "use strict";
            o.d(t, { hoverMouseEventFilter: () => n, useAccurateHover: () => s, useHover: () => a });
            var r = o(50959);
            function a() { const [e, t] = (0, r.useState)(!1); return [e, { onMouseOver: function (e) { n(e) && t(!0); }, onMouseOut: function (e) { n(e) && t(!1); } }]; }
            function n(e) { return !e.currentTarget.contains(e.relatedTarget); }
            function s(e) { const [t, o] = (0, r.useState)(!1); return (0, r.useEffect)((() => { const t = t => { if (null === e.current)
                return; const r = e.current.contains(t.target); o(r); }; return document.addEventListener("mouseover", t), () => document.removeEventListener("mouseover", t); }), []), t; }
        }, 90692: (e, t, o) => {
            "use strict";
            o.d(t, { MatchMedia: () => a });
            var r = o(50959);
            ...
            var r = o(50959), a = o(97754), n = o(51768), s = o(59064), i = o(76068), l = o(71986);
            const c = l;
            function d(e) { e.stopPropagation(); }
            function u(e) {
                const { id: t, role: o, className: c, title: u, labelRowClassName: m, labelClassName: h, toolboxClassName: p, shortcut: v, forceShowShortcuts: f, icon: b, iconClassname: g, isActive: y, isDisabled: _, isHovered: S, appearAsDisabled: k, label: x, link: w, showToolboxOnHover: I, showToolboxOnFocus: C, target: N, rel: E, toolbox: M, reference: D, onMouseOut: z, onMouseOver: L, onKeyDown: T, suppressToolboxClick: A = !0, theme: B = l, tabIndex: j, tagName: P, renderComponent: H, roundedIcon: R, iconAriaProps: O, circleLogo: W, dontClosePopup: F, onClick: U, onClickArg: Y, trackEventObject: q, trackMouseWheelClick: K, trackRightClick: V, ...Z } = e, G = (0, r.useRef)(null), J = (0, r.useMemo)((() => function (e) { function t(t) { const { reference: o, ...a } = t, n = null != e ? e : a.href ? "a" : "div", s = "a" === n ? a : function (e) { const { download: t, href: o, hrefLang: r, media: a, ping: n, rel: s, target: i, type: l, referrerPolicy: c, ...d } = e; return d; }(a); return r.createElement(n, { ...s, ref: o }); } return t.displayName = `DefaultComponent(${e})`, t; }(P)), [P]), X = null != H ? H : J;
                return r.createElement(X, { ...Z, id: t, role: o, className: a(c, B.item, b && B.withIcon, { [B.isActive]: y,
                        [B.isDisabled]: _ || k, [B.hovered]: S }), title: u, href: w, target: N, rel: E, reference: function (e) { G.current = e, "function" == typeof D && D(e); "object" == typeof D && (D.current = e); }, onClick: function (e) { if (_)
                        return; q && (0, n.trackEvent)(q.category, q.event, q.label); U && U(Y, e); F || (0, s.globalCloseMenu)(); }, onContextMenu: function (e) { q && V && (0, n.trackEvent)(q.category, q.event, `${q.label}_rightClick`); }, onMouseUp: function (e) { if (1 === e.button && w && q) {
                        let e = q.label;
                        K && (e += "_mouseWheelClick"), (0, n.trackEvent)(q.category, q.event, e);
                    } }, onMouseOver: L, onMouseOut: z, onKeyDown: T, tabIndex: j }, W && r.createElement(i.CircleLogo, { ...O, className: l["disclosure-item-circle-logo"], size: "xxxsmall", logoUrl: W.logoUrl, placeholderLetter: W.placeholderLetter }), b && r.createElement("span", { "aria-label": O && O["aria-label"], "aria-hidden": O && Boolean(O["aria-hidden"]), className: a(B.icon, R && l["round-icon"], g), dangerouslySetInnerHTML: { __html: b } }), r.createElement("span", { className: a(B.labelRow, m) }, r.createElement("span", { className: a(B.label, h) }, x)), (void 0 !== v || f) && r.createElement("span", { className: B.shortcut }, (Q = v) && Q.split("+").join(" + ")), void 0 !== M && r.createElement("span", { onClick: A ? d : void 0, className: a(p, B.toolbox, { [B.showOnHover]: I, [B.showOnFocus]: C }) }, M));
                var Q;
            }
        }, 29197: (e, t, o) => {
            "use strict";
            o.d(t, { CloseDelegateContext: () => n });
            var r = o(50959), a = o(59064);
            const n = r.createContext(a.globalCloseDelegate);
        }, 42842: (e, t, o) => {
            "use strict";
            o.d(t, { Portal: () => l, PortalContext: () => c });
            var r = o(50959), a = o(962), n = o(25931), s = o(67961), i = o(99663);
            class l extends r.PureComponent {
                constructor() { super(...arguments), this._uuid = (0, n.nanoid)(); }
                componentWillUnmount() { this._manager().removeWindow(this._uuid); }
                render() { const e = this._manager().ensureWindow(this._uuid, this.props.layerOptions); return e.style.top = this.props.top || "", e.style.bottom = this.props.bottom || "", e.style.left = this.props.left || "", e.style.right = this.props.right || "", e.style.pointerEvents = this.props.pointerEvents || "", this.props.className && e.classList.add(this.props.className), this.props["aria-hidden"] && e.setAttribute("aria-hidden", "true"), a.createPortal(r.createElement(c.Provider, { value: this }, this.props.children), e); }
                moveToTop() { this._manager().moveToTop(this._uuid); }
                _manager() { return null === this.context ? (0, s.getRootOverlapManager)() : this.context; }
            }
            ...
            var r = o(50959), a = o(59142), n = o(50151), s = o(49483);
            const i = (0, r.forwardRef)(((e, t) => { const { children: o, ...n } = e, i = (0, r.useRef)(null); return (0, r.useImperativeHandle)(t, (() => i.current)), (0, r.useLayoutEffect)((() => { if (s.CheckMobile.iOS())
                return null !== i.current && (0, a.disableBodyScroll)(i.current, { allowTouchMove: l(i) }), () => { null !== i.current && (0, a.enableBodyScroll)(i.current); }; }), []), r.createElement("div", { ref: i, ...n }, o); }));
            function l(e) { return t => { const o = (0, n.ensureNotNull)(e.current), r = document.activeElement; return !o.contains(t) || null !== r && o.contains(r) && r.contains(t); }; }
        }, 65890: e => {
        ...
        }, 16936: e => { e.exports = { ar: ["عودة"], ca_ES: ["Enrere"], cs: "Back", de: ["Zurück"], el: "Back", en: "Back", es: ["Atrás"], fa: "Back", fr: ["Retour"], he_IL: ["חזור"], hu_HU: "Back", id_ID: ["Kembali"], it: ["Indietro"], ja: ["戻る"], ko: ["뒤로"], ms_MY: ["Kembali"], nl_NL: "Back", pl: ["Cofnij"], pt: ["Voltar"], ro: "Back", ru: ["Назад"], sv: ["Tillbaka"], th: ["กลับไป"], tr: ["Geri"], vi: ["Quay lại"], zh: ["返回"], zh_TW: ["返回"] }; }, 9898: e => { e.exports = { ar: ["حق"], ca_ES: ["Right (dret de subscripció)"], cs: "Right", de: ["Rechter"], el: "Right", en: "Right", es: ["Right (derecho de suscripción)"], fa: "Right", fr: ["De droite"], he_IL: ["זכות Right"], hu_HU: "Right", id_ID: ["Kanan"], it: ["Diritto"], ja: ["ストックオプション"], ko: ["라이트"], ms_MY: ["Benar"], nl_NL: "Right", pl: ["Prawo do udostępniania"], pt: ["Direita"], ro: "Right", ru: ["Право на акцию"], sv: ["Höger"], th: ["สิทธิ"], tr: ["Sağ"], vi: ["Phải"], zh: ["认股权"], zh_TW: ["認股權"] }; }, 22320: e => {
            e.exports = { ar: ["مقارنة الرمز"], ca_ES: ["Compara el símbol"], cs: "Compare symbol", de: ["Symbol vergleichen"], el: "Compare symbol", en: "Compare symbol", es: ["Comparar el símbolo"], fa: "Compare symbol", fr: ["Comparer le symbole"], he_IL: ["השווה סימול"], hu_HU: "Compare symbol", id_ID: ["Bandingkan simbol"], it: ["Confronta simbolo"], ja: ["シンボルを比較"], ko: ["심볼 견주기"], ms_MY: ["Bandingkan simbol"], nl_NL: "Compare symbol", pl: ["Porównaj symbol"],
                pt: ["Comparar símbolos"], ro: "Compare symbol", ru: ["Сравнить символ"], sv: ["Jämför symbol"], th: ["เปรียบเทียบสัญลักษณ์"], tr: ["Sembolü karşılaştır"], vi: ["So sánh mã"], zh: ["比较商品"], zh_TW: ["比較商品"] };
