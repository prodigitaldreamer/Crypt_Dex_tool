...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[5009], { 46188: e => { e.exports = { container: "container-AhaeiE0y", list: "list-AhaeiE0y", overlayScrollWrap: "overlayScrollWrap-AhaeiE0y", scroll: "scroll-AhaeiE0y" }; }, 12961: e => { e.exports = { container: "container-huGG8x61", title: "title-huGG8x61" }; }, 12228: e => { e.exports = { itemRow: "itemRow-BadjY5sX", favoriteButton: "favoriteButton-BadjY5sX", active: "active-BadjY5sX", selected: "selected-BadjY5sX", mobile: "mobile-BadjY5sX", itemInfo: "itemInfo-BadjY5sX", title: "title-BadjY5sX", details: "details-BadjY5sX", itemInfoWithPadding: "itemInfoWithPadding-BadjY5sX", favorite: "favorite-BadjY5sX", removeButton: "removeButton-BadjY5sX" }; }, 40281: e => { e.exports = { container: "container-qm7Rg5MB", inputContainer: "inputContainer-qm7Rg5MB", withCancel: "withCancel-qm7Rg5MB", input: "input-qm7Rg5MB", icon: "icon-qm7Rg5MB", cancel: "cancel-qm7Rg5MB" }; }, 64409: e => { e.exports = { container: "container-RZoAcQrm", labelWrap: "labelWrap-RZoAcQrm", icon: "icon-RZoAcQrm", text: "text-RZoAcQrm" }; }, 33476: e => { e.exports = { sortButton: "sortButton-mMR_mxxG", icon: "icon-mMR_mxxG" }; }, 45300: e => { e.exports = {}; }, 75623: e => { e.exports = { highlighted: "highlighted-cwp8YRo6" }; }, 71986: e => { e.exports = { "tablet-small-breakpoint": "screen and (max-width: 430px)", item: "item-jFqVJoPk", hovered: "hovered-jFqVJoPk", isDisabled: "isDisabled-jFqVJoPk", isActive: "isActive-jFqVJoPk", shortcut: "shortcut-jFqVJoPk", toolbox: "toolbox-jFqVJoPk", withIcon: "withIcon-jFqVJoPk", "round-icon": "round-icon-jFqVJoPk", icon: "icon-jFqVJoPk", labelRow: "labelRow-jFqVJoPk", label: "label-jFqVJoPk", showOnHover: "showOnHover-jFqVJoPk", "disclosure-item-circle-logo": "disclosure-item-circle-logo-jFqVJoPk", showOnFocus: "showOnFocus-jFqVJoPk" }; }, 39416: (e, t, n) => {
            ...
            var a = n(97754);
            function o(e, t) { return a("tv-circle-logo", `tv-circle-logo--${e}`, t); }
            function i(e) { return "logoUrl" in e && void 0 !== e.logoUrl && 0 !== e.logoUrl.length; }
        }, 19785: (e, t, n) => {
            "use strict";
            n.d(t, { createRegExpList: () => i, getHighlightedChars: () => r, rankedSearch: () => o });
            var a = n(1722);
            function o(e) { const { data: t, rules: n, queryString: o, isPreventedFromFiltering: i, primaryKey: r, secondaryKey: l = r, optionalPrimaryKey: s, tertiaryKey: c } = e; return t.map((e => { const t = s && e[s] ? e[s] : e[r], i = e[l], u = c && e[c]; let m, d = 0; return n.forEach((e => { var n, r, l, s, c; const { re: h, fullMatch: f } = e; if (h.lastIndex = 0, (0, a.isString)(t) && t && t.toLowerCase() === o.toLowerCase())
                return d = 4, void (m = null === (n = t.match(f)) || void 0 === n ? void 0 : n.index); if ((0, a.isString)(t) && f.test(t))
                return d = 3, void (m = null === (r = t.match(f)) || void 0 === r ? void 0 : r.index); if ((0, a.isString)(i) && f.test(i))
                return d = 2, void (m = null === (l = i.match(f)) || void 0 === l ? void 0 : l.index); if ((0, a.isString)(i) && h.test(i))
                return d = 2, void (m = null === (s = i.match(h)) || void 0 === s ? void 0 : s.index); if (Array.isArray(u))
                for (const e of u)
                    if (f.test(e))
                        return d = 1, void (m = null === (c = e.match(f)) || void 0 === c ? void 0 : c.index); })), { matchPriority: d, matchIndex: m, item: e }; })).filter((e => i || e.matchPriority)).sort(((e, t) => { if (e.matchPriority < t.matchPriority)
            ...
            function i(e, t) { const n = [], a = e.toLowerCase(), o = e.split("").map(((e, t) => `(${0 !== t ? `[/\\s-]${l(e)}` : l(e)})`)).join("(.*?)") + "(.*)"; return n.push({ fullMatch: new RegExp(`(${l(e)})`, "i"), re: new RegExp(`^${o}`, "i"), reserveRe: new RegExp(o, "i"), fuzzyHighlight: !0 }), t && t.hasOwnProperty(a) && n.push({ fullMatch: t[a], re: t[a], fuzzyHighlight: !1 }), n; }
            function r(e, t, n) { const a = []; return e && n ? (n.forEach((e => { const { fullMatch: n, re: o, reserveRe: i } = e; n.lastIndex = 0, o.lastIndex = 0; const r = n.exec(t), l = r || o.exec(t) || i && i.exec(t); if (e.fuzzyHighlight = !r, l)
                if (e.fuzzyHighlight) {
                    let e = l.index;
                    for (let t = 1; t < l.length; t++) {
                        const n = l[t], o = l[t].length;
                        if (t % 2) {
            ...
            const te = I.enabled("items_favoriting"), ne = s.t(null, void 0, n(75789));
            function ae(e) {
                const { charts: t, onClose: o, favoriteChartsService: i, chartWidgetCollection: d } = e, [h, f] = (0, a.useState)(""), [g, y] = (0, a.useState)(h), [v, _] = (0, a.useState)([]), b = (0, a.useRef)(null), [k, D] = (0, a.useState)((function () { if (i)
                    return i.get(); const e = {}; return t.filter((e => e.favorite)).forEach((t => { e[t.id] = !0; })), e; })), [S, A] = (0, a.useState)((() => c.getJSON("loadChartDialog.viewState", G))), x = (0, a.useRef)(null), N = (0, a.useRef)(null), M = (0, a.useMemo)((() => t.map((e => ({ ...e, description: `${e.symbol}, ${ee(e.interval)}` })))), [t]);
                (0, a.useEffect)((() => { u.CheckMobile.any() || (0, l.ensureNotNull)(x.current).focus(); }), []);
                const F = (0, a.useRef)();
                (0, a.useEffect)((() => (F.current = setTimeout((() => { f(g); }), 300), () => { clearTimeout(F.current); })), [g]), (0, a.useEffect)((() => (null == i || i.getOnChange().subscribe(null, q), () => { null == i || i.getOnChange().unsubscribe(null, q); })), []);
                const T = (0, a.useCallback)((() => !0), []), I = (0, a.useMemo)((() => { return (0, H.rankedSearch)({ data: M.filter((e => !v.includes(e.id))).sort((e = S.sortDirection, (t, n) => { if (k[t.id] && !k[n.id])
                        return -1; if (!k[t.id] && k[n.id])
                        return 1; const a = 0 === e ? 1 : -1; return "modified" === S.sortField ? a * (t.modified - n.modified) : a * t.title.localeCompare(n.title); })), rules: (0, H.createRegExpList)(h), queryString: h, primaryKey: "title", secondaryKey: "description" }); var e; }), [h, S, v, k]), { selectedItemIndex: B, setSelectedItemIndex: R, handleKeyboardSelection: Z } = function (e, t, n) { const [o, i] = (0, a.useState)(-1); return (0, a.useEffect)((() => { var e; -1 !== o && (null === (e = n.current) || void 0 === e || e.scrollToItem(o)); }), [o]), { selectedItemIndex: o, setSelectedItemIndex: i, handleKeyboardSelection: function (n) { switch ((0, $.hashFromEvent)(n)) {
                        case 40:
                            if (o === e - 1)
                                return;
                            i(o + 1);
