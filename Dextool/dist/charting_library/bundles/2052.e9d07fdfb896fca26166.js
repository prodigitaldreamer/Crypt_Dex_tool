...
(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[2052], { 45300: e => { e.exports = {}; }, 66076: e => { e.exports = { "default-drawer-min-top-distance": "100px", wrap: "wrap-_HnK0UIN", positionBottom: "positionBottom-_HnK0UIN", backdrop: "backdrop-_HnK0UIN", drawer: "drawer-_HnK0UIN", positionLeft: "positionLeft-_HnK0UIN" }; }, 71986: e => { e.exports = { "tablet-small-breakpoint": "screen and (max-width: 430px)", item: "item-jFqVJoPk", hovered: "hovered-jFqVJoPk", isDisabled: "isDisabled-jFqVJoPk", isActive: "isActive-jFqVJoPk", shortcut: "shortcut-jFqVJoPk", toolbox: "toolbox-jFqVJoPk", withIcon: "withIcon-jFqVJoPk", "round-icon": "round-icon-jFqVJoPk", icon: "icon-jFqVJoPk", labelRow: "labelRow-jFqVJoPk", label: "label-jFqVJoPk", showOnHover: "showOnHover-jFqVJoPk", "disclosure-item-circle-logo": "disclosure-item-circle-logo-jFqVJoPk", showOnFocus: "showOnFocus-jFqVJoPk" }; }, 34587: e => { e.exports = { icon: "icon-WB2y0EnP", dropped: "dropped-WB2y0EnP" }; }, 39416: (e, t, o) => {
            ...
            "use strict";
            function n(e, t, o, n, r) { function i(r) { if (e > r.timeStamp)
                return; const i = r.target; void 0 !== o && null !== t && null !== i && i.ownerDocument === n && (t.contains(i) || o(r)); } return r.click && n.addEventListener("click", i, !1), r.mouseDown && n.addEventListener("mousedown", i, !1), r.touchEnd && n.addEventListener("touchend", i, !1), r.touchStart && n.addEventListener("touchstart", i, !1), () => { n.removeEventListener("click", i, !1), n.removeEventListener("mousedown", i, !1), n.removeEventListener("touchend", i, !1), n.removeEventListener("touchstart", i, !1); }; }
            o.d(t, { addOutsideEventListener: () => n });
        }, 90186: (e, t, o) => {
            "use strict";
            function n(e) { return i(e, a); }
            function r(e) { return i(e, s); }
            function i(e, t) { const o = Object.entries(e).filter(t), n = {}; for (const [e, t] of o)
                n[e] = t; return n; }
            ...
            var n = o(50959), r = o(39416), i = o(16838);
            function a(e, t = []) {
                const [o, a] = (0, n.useState)(!1), s = (0, r.useFunctionalRefObject)(e);
                return (0, n.useLayoutEffect)((() => {
                    if (!i.PLATFORM_ACCESSIBILITY_ENABLED)
                        return;
                    const e = s.current;
                    if (null === e)
                        return;
                    const t = e => {
                        switch (e.type) {
                            case "roving-tabindex:main-element":
                                a(!0);
                                break;
                            case "roving-tabindex:secondary-element": a(!1);
                        }
                    };
                    return e.addEventListener("roving-tabindex:main-element", t), e.addEventListener("roving-tabindex:secondary-element", t), () => { e.removeEventListener("roving-tabindex:main-element", t), e.removeEventListener("roving-tabindex:secondary-element", t); };
                }), t), [s, i.PLATFORM_ACCESSIBILITY_ENABLED ? o ? 0 : -1 : void 0];
            }
        }, 76068: (e, t, o) => {
            "use strict";
            o.d(t, { CircleLogo: () => a, hiddenCircleLogoClass: () => i });
            var n = o(50959), r = o(58492);
            o(45300);
            const i = "tv-circle-logo--visually-hidden";
            function a(e) { var t, o; const i = (0, r.getStyleClasses)(e.size, e.className), a = null !== (o = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== o ? o : ""; return (0, r.isCircleLogoWithUrlProps)(e) ? n.createElement("img", { className: i, crossOrigin: "", src: e.logoUrl, alt: a, title: e.title, loading: e.loading, "aria-label": e["aria-label"], "aria-hidden": e["aria-hidden"] }) : n.createElement("span", { className: i, title: e.title, "aria-label": e["aria-label"], "aria-hidden": e["aria-hidden"] }, e.placeholderLetter); }
        }, 58492: (e, t, o) => {
            "use strict";
            o.d(t, { getStyleClasses: () => r, isCircleLogoWithUrlProps: () => i });
            var n = o(97754);
            function r(e, t) { return n("tv-circle-logo", `tv-circle-logo--${e}`, t); }
            ...
            class i extends n.PureComponent {
                ...
                render() { return n.createElement(a.Provider, { value: { addDrawer: this._addDrawer, removeDrawer: this._removeDrawer, currentDrawer: this.state.stack.length ? this.state.stack[this.state.stack.length - 1] : null } }, this.props.children); }
            }
            const a = n.createContext(null);
        }, 41590: (e, t, o) => {
            "use strict";
            o.d(t, { Drawer: () => h });
            var n = o(50959), r = o(50151), i = o(97754), a = o(36174), s = o(42842), l = o(37558), c = o(29197), d = o(86656), u = o(66076);
            function h(e) { const { position: t = "Bottom", onClose: o, children: d, className: h, theme: m = u } = e, f = (0, r.ensureNotNull)((0, n.useContext)(l.DrawerContext)), [v] = (0, n.useState)((() => (0, a.randomHash)())), g = (0, n.useRef)(null), b = (0, n.useContext)(c.CloseDelegateContext); return (0, n.useLayoutEffect)((() => ((0, r.ensureNotNull)(g.current).focus({ preventScroll: !0 }), b.subscribe(f, o), f.addDrawer(v), () => { f.removeDrawer(v), b.unsubscribe(f, o); })), []), n.createElement(s.Portal, null, n.createElement("div", { className: i(u.wrap, u[`position${t}`]) }, v === f.currentDrawer && n.createElement("div", { className: u.backdrop, onClick: o }), n.createElement(p, { className: i(m.drawer, u[`position${t}`], h), ref: g, "data-name": e["data-name"] }, d))); }
            const p = (0, n.forwardRef)(((e, t) => { const { className: o, ...r } = e; return n.createElement(d.TouchScrollContainer, { className: i(u.drawer, o), tabIndex: -1, ref: t, ...r }); }));
        }, 16396: (e, t, o) => {
            "use strict";
            o.d(t, { DEFAULT_POPUP_MENU_ITEM_THEME: () => c, PopupMenuItem: () => u });
            var n = o(50959), r = o(97754), i = o(51768), a = o(59064), s = o(76068), l = o(71986);
            const c = l;
            function d(e) { e.stopPropagation(); }
            function u(e) { const { id: t, role: o, className: c, title: u, labelRowClassName: h, labelClassName: p, toolboxClassName: m, shortcut: f, forceShowShortcuts: v, icon: g, iconClassname: b, isActive: E, isDisabled: w, isHovered: C, appearAsDisabled: k, label: D, link: x, showToolboxOnHover: y, showToolboxOnFocus: N, target: T, rel: _, toolbox: O, reference: M, onMouseOut: L, onMouseOver: B, onKeyDown: F, suppressToolboxClick: A = !0, theme: S = l, tabIndex: P, tagName: I, renderComponent: R, roundedIcon: W, iconAriaProps: U, circleLogo: j, dontClosePopup: H, onClick: Q, onClickArg: z, trackEventObject: K, trackMouseWheelClick: q, trackRightClick: V, ...G } = e, J = (0, n.useRef)(null), $ = (0, n.useMemo)((() => function (e) { function t(t) { const { reference: o, ...r } = t, i = null != e ? e : r.href ? "a" : "div", a = "a" === i ? r : function (e) { const { download: t, href: o, hrefLang: n, media: r, ping: i, rel: a, target: s, type: l, referrerPolicy: c, ...d } = e; return d; }(r); return n.createElement(i, { ...a, ref: o }); } return t.displayName = `DefaultComponent(${e})`, t; }(I)), [I]), Y = null != R ? R : $; return n.createElement(Y, { ...G, id: t, role: o, className: r(c, S.item, g && S.withIcon, { [S.isActive]: E, [S.isDisabled]: w || k, [S.hovered]: C }), title: u, href: x, target: T, rel: _, reference: function (e) { J.current = e, "function" == typeof M && M(e); "object" == typeof M && (M.current = e); }, onClick: function (e) { if (w)
                    return; K && (0, i.trackEvent)(K.category, K.event, K.label); Q && Q(z, e); H || (0, a.globalCloseMenu)(); }, onContextMenu: function (e) { K && V && (0, i.trackEvent)(K.category, K.event, `${K.label}_rightClick`); }, onMouseUp: function (e) { if (1 === e.button && x && K) {
                    let e = K.label;
                    q && (e += "_mouseWheelClick"), (0, i.trackEvent)(K.category, K.event, e);
                } }, onMouseOver: B, onMouseOut: L, onKeyDown: F, tabIndex: P }, j && n.createElement(s.CircleLogo, { ...U, className: l["disclosure-item-circle-logo"], size: "xxxsmall", logoUrl: j.logoUrl, placeholderLetter: j.placeholderLetter }), g && n.createElement("span", { "aria-label": U && U["aria-label"], "aria-hidden": U && Boolean(U["aria-hidden"]), className: r(S.icon, W && l["round-icon"], b), dangerouslySetInnerHTML: { __html: g } }), n.createElement("span", { className: r(S.labelRow, h) }, n.createElement("span", { className: r(S.label, p) }, D)), (void 0 !== f || v) && n.createElement("span", { className: S.shortcut }, (X = f) && X.split("+").join(" + ")), void 0 !== O && n.createElement("span", { onClick: A ? d : void 0, className: r(m, S.toolbox, { [S.showOnHover]: y, [S.showOnFocus]: N }) }, O)); var X; }
        }, 20520: (e, t, o) => {
            "use strict";
            o.d(t, { PopupMenu: () => h });
            var n = o(50959), r = o(962), i = o(62942), a = o(42842), s = o(27317), l = o(29197);
            const c = n.createContext(void 0);
            var d = o(36383);
            const u = n.createContext({ setMenuMaxWidth: !1 });
            function h(e) {
                const { controller: t, children: o, isOpened: h, closeOnClickOutside: p = !0, doNotCloseOn: m, onClickOutside: f, onClose: v, onKeyboardClose: g, "data-name": b = "popup-menu-container", ...E } = e, w = (0,
                    n.useContext)(l.CloseDelegateContext), C = n.useContext(u), k = (0, n.useContext)(c), D = (0, d.useOutsideEvent)({ handler: function (e) { f && f(e); if (!p)
                        return; const t = (0, i.default)(m) ? m() : null == m ? [] : [m]; if (t.length > 0 && e.target instanceof Node)
                        for (const o of t) {
                            const t = r.findDOMNode(o);
                            if (t instanceof Node && t.contains(e.target))
                                return;
                        } v(); }, mouseDown: !0, touchStart: !0 });
                return h ? n.createElement(a.Portal, { top: "0", left: "0", right: "0", bottom: "0", pointerEvents: "none" }, n.createElement("span", { ref: D, style: { pointerEvents: "auto" } }, n.createElement(s.Menu, { ...E, onClose: v, onKeyboardClose: g, onScroll: function (t) { const { onScroll: o } = e; o && o(t); }, customCloseDelegate: w, customRemeasureDelegate: k, ref: t, "data-name": b, limitMaxWidth: C.setMenuMaxWidth }, o))) : null;
            }
        }, 10381: (e, t, o) => {
            "use strict";
            o.d(t, { ToolWidgetCaret: () => l });
            var n = o(50959), r = o(97754), i = o(9745), a = o(34587), s = o(578);
            function l(e) { const { dropped: t, className: o } = e; return n.createElement(i.Icon, { className: r(o, a.icon, { [a.dropped]: t }), icon: s }); }
        }, 86656: (e, t, o) => {
            "use strict";
            o.d(t, { TouchScrollContainer: () => s });
            var n = o(50959), r = o(59142), i = o(50151), a = o(49483);
            const s = (0, n.forwardRef)(((e, t) => { const { children: o, ...i } = e, s = (0, n.useRef)(null); return (0, n.useImperativeHandle)(t, (() => s.current)), (0, n.useLayoutEffect)((() => { if (a.CheckMobile.iOS())
                return null !== s.current && (0, r.disableBodyScroll)(s.current, { allowTouchMove: l(s) }), () => { null !== s.current && (0, r.enableBodyScroll)(s.current); }; }), []), n.createElement("div", { ref: s, ...i }, o); }));
            function l(e) { return t => { const o = (0, i.ensureNotNull)(e.current), n = document.activeElement; return !o.contains(t) || null !== n && o.contains(n) && n.contains(t); }; }
        }, 78029: e => { e.exports = { button: "button-GwQQdU8S", hover: "hover-GwQQdU8S", clicked: "clicked-GwQQdU8S", isInteractive: "isInteractive-GwQQdU8S", accessible: "accessible-GwQQdU8S", isGrouped: "isGrouped-GwQQdU8S", isActive: "isActive-GwQQdU8S", isOpened: "isOpened-GwQQdU8S", isDisabled: "isDisabled-GwQQdU8S", text: "text-GwQQdU8S", icon: "icon-GwQQdU8S", endIcon: "endIcon-GwQQdU8S" }; }, 2869: e => { e.exports = { button: "button-xNqEcuN2" }; }, 42919: e => { e.exports = { button: "button-merBkM5y", hover: "hover-merBkM5y", clicked: "clicked-merBkM5y", accessible: "accessible-merBkM5y", arrow: "arrow-merBkM5y", arrowWrap: "arrowWrap-merBkM5y", isOpened: "isOpened-merBkM5y" }; }, 81261: (e, t, o) => {
            "use strict";
            o.d(t, { focusFirstMenuItem: () => c, handleAccessibleMenuFocus: () => s, handleAccessibleMenuKeyDown: () => l, queryMenuElements: () => h });
            var n = o(16838), r = o(71468), i = o(68335);
            const a = [37, 39, 38, 40];
            function s(e, t) { e.target && n.PLATFORM_ACCESSIBILITY_ENABLED && e.relatedTarget === t.current && c(e.target); }
            function l(e) {
                var t;
                if (!n.PLATFORM_ACCESSIBILITY_ENABLED)
                    return;
                ...
                if (-1 === m)
                    return;
                const f = p(c), v = f.indexOf(document.activeElement), g = -1 !== v, b = e => { s && (0, r.becomeSecondaryElement)(s), (0, r.becomeMainElement)(e), e.focus(); };
            ...
            function c(e) { const [t] = h(e); t && ((0, r.becomeMainElement)(t), t.focus()); }
            function d(e, t, o) { return e[(t + e.length + o) % e.length]; }
            function u(e, t) { const o = p(e); return o.length ? o[(t + o.length) % o.length] : null; }
            function h(e) { return Array.from(e.querySelectorAll('[data-role="menuitem"]:not([disabled]):not([aria-disabled])')).filter((0, n.createScopedVisibleElementFilter)(e)); }
            function p(e) { return Array.from(e.querySelectorAll("[tabindex]:not([disabled]):not([aria-disabled])")).filter((0, n.createScopedVisibleElementFilter)(e)); }
        }, 71468: (e, t, o) => {
            "use strict";
                ...
                constructor(e) {
                    super(e), this._wrapperRef = null, this._controller = n.createRef(), this._handleWrapperRef = e => { this._wrapperRef = e, this.props.reference && this.props.reference(e); }, this._handleOpen = () => { var e; "div" !== this.props.tag && (null === (e = this._controller.current) || void 0 === e || e.focus()); }, this._handleClick = e => { (p.enabled("skip_event_target_check") || e.target instanceof Node) && e.currentTarget.contains(e.target) && (this._handleToggleDropdown(void 0, (0, m.isKeyboardClick)(e)), this.props.onClick && this.props.onClick(e, !this.state.isOpened)); }, this._handleToggleDropdown = (e, t = !1) => { const { onClose: o, onOpen: n } = this.props, { isOpened: r } = this.state, i = "boolean" == typeof e ? e : !r; this.setState({ isOpened: i, shouldReturnFocus: !!i && t }), i && n && n(), !i && o && o(); }, this._handleClose = () => { this.close(); }, this._handleKeyDown = e => {
                        ...
                        if (e.currentTarget.contains(e.target))
                            switch (n) {
                                case 40:
                                    if ("div" === this.props.tag || "horizontal" !== o)
                                        return;
